...
blueSu <- sentRCVspring$summerB02
...
### 4b. Create a 10-band stack from both images
```{r}
sentRCV <- c(sentRCVspring$springB02,sentRCVspring$springB03,
             sentRCVspring$springB04,NDGIspring,NDGIsummer)
names(sentRCV) <- c("sprB02","sprB03","sprB04","sprNDGI","sumNDGI")
```
...
#classdf
#LULCcolors <- c("springgreen4","cyan","gold","black","dodgerblue","greenyellow","red")
