...
# Background, Goals & Data {#chapter00.chapter_section .intro_section}
...
\index{environmental data science}*Environmental* data science is data science applied to environmental science research. In general data science can be seen as being the intersection of math & statistics, computer science/IT, and some research domain, and in this case it's environmental (Figure \@ref(fig:indexEDS)).
...
For a start, you'll need to have R and \index{RStudio}RStudio installed, and you'll need to install various \index{packages}packages to support specific chapters and sections:
